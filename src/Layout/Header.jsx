...
export function Header() {
  ...
  const navList = (
    <ul className="pt-2 pb-4 flex flex-col gap-2 lg:pb-0 lg:pt-0 border-none lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a href="#aaa" className="flex  text-neutral-950 dark:text-[#FFD700]  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
        {t("home")}
        </a>
      ...
      >
        ...
        {/* <NavLink to={"/about"} className="flex  text-neutral-950 dark:text-[#FFD700]  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
          {t("about")}

        </NavLink> */}
        <a href="#sss" className="flex  text-neutral-950 dark:text-[#FFD700]  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
        {t("about")}
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a href="#zzz" className="flex  text-neutral-950 dark:text-[#FFD700]  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
        {t("contact")}
        </a>
      ...
      >
        ...
        <a href="#ddd" className="flex  text-neutral-950 dark:text-[#FFD700]  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
        {t("skil")}
        </a>
  ...
  // const { t } = useTranslation("layout");
  return (
    <Navbar className=" border-none sticky top-0 bg-neutral-100 dark:bg-[#0e2624] rounded-none mx-auto max-w-screen px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        <Typography
          as="a"
          href="#"
          className="mr-4 cursor-pointer py-1.5 text-4xl font-medium"
        >
          <NavLink to={"/"} className=" text-neutral-950 dark:text-[#FFD700]  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer">
            FX
          </NavLink>
        </Typography>
        ...
        <IconButton
          variant="text"
          className="ml-auto bg-white h-6 w-6 text-inherit  focus:bg-transparent  lg:hidden"
          ripple={false}
