...
export function Header() {
  ...
  const navList = (
    <ul className="pt-2 pb-4 flex flex-col gap-2 lg:pb-0 lg:pt-0 border-none lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <NavLink to={"/"} className="flex text-neutral-950 dark:text-neutral-100  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
          {/* {t("home")} */}
          {t("home")}
        </NavLink>
      </Typography>
      ...
      >
        ...
        <NavLink to={"/about"} className="flex  text-neutral-950 dark:text-neutral-100  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
          {t("about")}
      ...
      >
        ...
        <NavLink to={"/contact"} className="flex  text-neutral-950 dark:text-neutral-100  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer items-center">
          {t("contact")}
        </NavLink>
      </Typography>
  ...
  // const { t } = useTranslation("layout");
  return (
    <Navbar className=" border-none bg-neutral-100 dark:bg-neutral-950 mx-auto max-w-screen px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        >
          <NavLink to={"/"} className=" text-neutral-950 dark:text-neutral-100  hover:text-teal-700 dark:hover:text-teal-700 cursor-pointer">
            FX
          </NavLink>
        </Typography>
